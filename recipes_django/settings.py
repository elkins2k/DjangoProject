"""
Django settings for recipes_django project.
...
ALLOWED_HOSTS = ['taste-e.herokuapp.com', 'localhost', '127.0.0.1',]
...
WSGI_APPLICATION = 'recipes_django.wsgi.application'
...
if USE_S3:
    ...
    DEFAULT_FILE_STORAGE = 'recipes_django.storage_backends.PublicMediaStorage'
else:
    MEDIA_URL = '/media/'
